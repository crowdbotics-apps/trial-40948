"""
Django settings for trial_40948 project.
...
WSGI_APPLICATION = 'trial_40948.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "trial_40948 API",
    "DESCRIPTION": "API documentation for trial_40948 App",
    "VERSION": "v1",
}
